...
//        Computer Graphics and Geometry Laboratory, EPF Lausanne,
//        Applied Geometry Group and Computer Graphics Laboratory, ETH Zurich
//                                                                         
//-----------------------------------------------------------------------------
//                                                                            
//                                License                                     
...
GlutExaminer::rotation(int x, int y)
{
  if (last_point_ok_) 
  {
    ...
    if (new_point_ok)
    {
      Vec3f axis      = surface_mesh::cross(last_point_3D_, new_point_3D);
      float cos_angle = surface_mesh::dot(last_point_3D_, new_point_3D);
...
GlutExaminer::measure_fps()
{
  ...
  fps = ((double) CLOCKS_PER_SEC / (end-start) * (3.0 * frames));
